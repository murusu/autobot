...
///////////////////////////////////////////////////////////////////////////////
/// Class DialogTaskConfig
///////////////////////////////////////////////////////////////////////////////
class DialogTaskConfig : public wxDialog 
{
	private:
	...
	public:
		...
		DialogTaskConfig( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("Task Setting"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 600,400 ), long style = wxDEFAULT_DIALOG_STYLE );
		~DialogTaskConfig();
...
///////////////////////////////////////////////////////////////////////////////
class DialogActionConfig : public wxDialog 
{
	private:
	...
	public:
		...
		DialogActionConfig( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("Action Setting"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 600,400 ), long style = wxDEFAULT_DIALOG_STYLE );
		~DialogActionConfig();
